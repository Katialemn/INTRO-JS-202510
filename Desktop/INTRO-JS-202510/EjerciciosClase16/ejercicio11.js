...
let nombresExtra = ["Lucía", "Ana", "María", "Luis", "José", "Pablo"];

let cortos = nombresExtra.filter(n => n.length < 5);

let mayus = cortos.map(n => n.toUpperCase());

let fraseFinal = `Los nombres seleccionados son: ${mayus.join(", ")}`;
