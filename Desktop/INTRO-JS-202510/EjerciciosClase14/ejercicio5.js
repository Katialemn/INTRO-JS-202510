...
const verificarOrigen = marca => {
  let nacionales = ["Chevrolet", "Ford", "Fiat"];
  return nacionales.includes(marca) ? "Nacional" : "Importado";
};

let marca = prompt("Ingresá la marca del auto: ");
console.log("El auto es:", verificarOrigen(marca));
