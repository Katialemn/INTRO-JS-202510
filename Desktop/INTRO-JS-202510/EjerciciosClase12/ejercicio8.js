...
function diagonalRoja(matriz) {
  let valores = []; // usamos push 

  for (let i = 0; i < matriz.length; i++) {
    valores.push(matriz[i][i]); // diagonal principal
  }
...
function diagonalVerde(matriz) {
  ...
  for (let i = 0; i < matriz.length; i++) {
    valores.push(matriz[i][matriz.length - 1 - i]); // diagonal secundaria
  }
...
console.log("Diagonal roja:", diagonalRoja(matriz));
console.log("Diagonal verde:", diagonalVerde(matriz));
